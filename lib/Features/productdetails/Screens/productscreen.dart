...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  int _selectedSize = -1; // Initialize to no size selected
          ...
          children: [
            ...
            ClipRRect(
              ...
              child: GestureDetector(
                onTap: () {
                  //  to show the image in a bigger view here
                },
                child: Image.asset(
                  _productImages[_currentImageIndex],
                  height: 360, // Increase the size
                  width: 360, // Increase the size
                ),
              ),
            ),
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return GestureDetector(
                    ...
                    child: Padding(
                      // the size of the smaller images
                        ...
                        decoration: BoxDecoration(
                          border: Border.all(
                            color: _currentImageIndex == index
                                ? Colors.blue // Highlighted border color
            ...
            const Padding(
              padding: EdgeInsets.all(8.0),
              child: Text(
                "Saddle up and head west. More eye-catching than the whirling dust of thundering with horsehair leather and woven details. And don't worry—you won't be hoofing it in these. We harnessed research from the Nike Sport Research Lab (NSRL) to help each step feel as natural as possible, kinda like wearing your favourite worn-in jeans. Time to ride!",
                style: TextStyle(
                  fontSize: 14.0,
                  color: Colors.grey,
                ),
    ...
    return GestureDetector(
      ...
      child: Padding(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            border: Border.all(
              color: _selectedSize == index ? Colors.blue : Colors.black,
              width: 2.0,
            ),
            borderRadius: BorderRadius.circular(10.0),
            color: _selectedSize == index ? Colors.blue : Colors.white,
          ),
          child: Center(
            child: Text(
              size,
